...
Result<void, Win32::DWORD> Window::init(i32 width, i32 height) {
    ...
    Win32::SetWindowLongPtrA(hwnd, Win32::WindowLongPointer::UserData, (Win32::LONG_PTR)this);
...
void Window::poll() {
    Win32::MSG message;
    if (Win32::PeekMessageA(&message, 0, 0, 0, Win32::PeekMessageOption::Remove)) {
...
WIN32_DECLARE_WNDPROC(wnd_proc_handler) {
    Window *w = (Window*)Win32::GetWindowLongPtrA(hwnd, Win32::WindowLongPointer::UserData);
